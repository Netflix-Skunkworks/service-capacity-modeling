...
class CostAwareModel:
    ...
    # Service name for cost key naming (e.g., "cassandra.zonal-clusters").
    # Must be overridden by each CostAwareModel implementation.
    service_name: str = "unknown"

    # Cluster types this model handles (e.g., ("cassandra",)).
    # Used by extract_baseline_plan() to route costs to the correct model.
