...
from service_capacity_modeling.models import _stateful_zone
...
# Public stateful-zone helpers live in a private module, but stay importable
# from common.py for compatibility and discoverability.
compute_stateful_zone = _stateful_zone.compute_stateful_zone
cloud_gib_for_io = _stateful_zone.cloud_gib_for_io
gp2_gib_for_io = _stateful_zone.gp2_gib_for_io
