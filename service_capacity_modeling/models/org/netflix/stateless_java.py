...
def _estimate_java_app_region(  # pylint: disable=too-many-positional-arguments
    ...
    if cluster.count <= 256:
        # Use CostAwareModel methods for consistent cost calculation
...
class NflxJavaAppCapacityModel(CapacityModel, CostAwareModel):
    ...
    def cluster_costs(
        ...
        return cluster_infra_cost(
            ...
            zonal_clusters,
            regional_clusters,
            cluster_types=NflxJavaAppCapacityModel.cluster_types,
        )
    ...
    def service_costs(
        ...
        Java apps incur network costs for cross-zone traffic.
        """
