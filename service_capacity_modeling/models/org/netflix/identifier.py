...
class NflxIdentifierCapacityModel(CapacityModel):
    ...
    def capacity_plan(
        ...
        # Identifier wants 20GiB root volumes
        extra_model_arguments.setdefault("root_disk_gib", 20)

        identifier_app = nflx_java_app_capacity_model.capacity_plan(
            instance=instance,
            drive=drive,
            context=context,
            desires=desires,
        ...
        if identifier_app is None:
            return None

        for cluster in identifier_app.candidate_clusters.regional:
            cluster.cluster_type = "dgwidentifier"
        return identifier_app

    @staticmethod
    def description() -> str:
        return "Netflix Identifier Model"
    ...
    def default_desires(
        ...
        return CapacityDesires(
            ...
            # Most Identifier clusters are small
...
nflx_identifier_capacity_model = NflxIdentifierCapacityModel()
