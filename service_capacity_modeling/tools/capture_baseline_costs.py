...
# Anonymized from a production cluster. Key: NO memory_utilization_gib.
# The experimental memory model's conservative fallback estimates page cache
# from (RAM - heap - base_mem), producing a ~3% working set instead of the
# legacy ~30%. This lets the planner pick smaller (cheaper) instances.
